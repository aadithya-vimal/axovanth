        ...
        <div className="p-3 lg:p-4 bg-background/80 backdrop-blur-xl border-t border-border">
          ...
          >
            ...
            <button 
              ...
              className="h-10 w-10 flex-shrink-0 flex items-center justify-center rounded-full hover:bg-foreground/5 text-muted hover:text-foreground transition-colors disabled:opacity-50"
            >
              {isUploading ? <Loader2 className="w-5 h-5 animate-spin text-accent" /> : <Paperclip className="w-5 h-5" />}
            </button>
            
            {/* FORCE SINGLE ROW HEIGHT */}
            <textarea 
              rows={1}
              placeholder="Transmit message..." 
              className="flex-1 bg-transparent border-none outline-none py-2.5 max-h-32 min-h-[40px] resize-none text-sm font-medium text-foreground placeholder:text-muted/70 custom-scrollbar leading-relaxed"
              value={message}
            ...
            <button 
              ...
              className="h-10 w-10 flex-shrink-0 flex items-center justify-center bg-accent hover:bg-accent/90 disabled:bg-muted disabled:cursor-not-allowed rounded-full text-white transition-all shadow-md shadow-accent/20 group"
            >
